...
# Default values
APP_NAME="api-integrasi-aminah-jaya"
IMAGE_TAG="latest"

# Handle variable mapping from Rust .env to VPS config
VPS_IP=${VPS_IP:-$SSH_HOST}
VPS_USER=${VPS_USER:-$SSH_USER}
VPS_PATH=${VPS_PATH:-"/home/ubuntu24/projects/aminah-jaya/api-integrasi-aminah-jaya"}
HOST_PORT=${PORT:-8002} # Default to 8002 if not set
